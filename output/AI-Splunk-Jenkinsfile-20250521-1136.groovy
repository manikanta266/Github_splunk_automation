...
pipeline {
  ...
  environment {
    INDEX_NAME = 'deep-serverlogs-logs'
  
    REPO_NAME = 'Application_Server_Logs'
    REPO_URL = 'https://github.com/yaswanthkumar12-cmyk/Application_Server_Logs'
    SPLUNK_USERNAME = 'MTL1013'
    SPLUNK_PASSWORD = 'MTL@1013'
    SPLUNK_APPS_DIR = 'C:\program files\Splunk\etc\apps'
    EMAIL_RECIPIENT = 'Yaswanth@middlewaretalents.com'
  }
  triggers {
    cron('38 11 21 5 1')
  }
