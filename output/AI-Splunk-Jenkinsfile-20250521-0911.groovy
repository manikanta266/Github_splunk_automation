...
pipeline {
  ...
  environment {
    INDEX_NAME = 'smart-employee_application_logs-yaswanth_kumarch-insights'
  
    REPO_NAME = 'Autoamation_Github_To_Splunk'
    REPO_URL = 'https://github.com/yaswanthkumarch/Autoamation_Github_To_Splunk'
