...
pipeline {
  ...
  environment {
    INDEX_NAME = 'predictive-employee-application-logs-data'
    MONITOR_PATH = '/var/log/app/*.log'
    SOURCE_TYPE = '/var/log/app/*.log'
    REPO_NAME = 'birthdayhub.io'
    REPO_URL = 'https://github.com/yaswanthkumarch/birthday.github.io'
